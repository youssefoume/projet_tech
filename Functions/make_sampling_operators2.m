...
%     ptn1=[12    16     1    13    15     9     4     6    11    14     5     7     2     8     3    10];
    ptn1=[1,5,9,13,2,6,10,14,3,7,11,15,4,8,12,16];%Xemia
elseif num_band==25
%      ptn1=[9 4 25 2 13 14 12 3 5 18 1 22 11 20 23 7 8 10 6 19 24 21 15 17 16];%IMEC
     ptn1=[1,6,11,16,21,2,7,12,17,22,3,8,13,18,23,4,9,14,19,24,5,10,15,20,25];%Photonfocus
%      ptn1=[1:25];
else
